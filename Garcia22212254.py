...
_,Vs1u1 = ctrl.forced_response(sys,t,u1,x0)
_,Vs1u2 = ctrl.forced_response(sys,t,u2,x0)
_,Vs1u3 = ctrl.forced_response(sys,t,u3,x0)
_,Vs1u4 = ctrl.forced_response(sys,t,u4,x0)
...
plt.plot(t,Vs1u1,'--',color = clr2,label = 'Vs1(t)')
...
plt.plot(t,Vs1u2,'--',color = clr2,label = 'Vs1(t)')
...
plt.plot(t,Vs1u3,'--',color = clr2,label = 'Vs1(t)')
...
plt.plot(t,Vs1u4,'--',color = clr2,label = 'Vs1(t)')
